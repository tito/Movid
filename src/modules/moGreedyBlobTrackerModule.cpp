...
// FIXME add constructor back in or we'll get a crash cause max_weight ain't defined
//moGreedyBlobTrackerModule::moGreedyBlobTrackerModule() : moAbstractBlobTrackerModule(MO_MODULE_INPUT | MO_MODULE_OUTPUT) {
